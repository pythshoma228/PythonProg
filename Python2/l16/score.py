...
def goods(product_list):
		...
		if buy_prod == '2':
			scor = Score(input('1 - мороженое, 2 - яблоки, 3 - воду, 4 - чипсы, 5 - мясо:  '),\
input("Купить?  "), input("Введите пароль:  "))
			scor.buy(product_list)
		if buy_prod == '1':
			scor = Score(input('1 - мороженое, 2 - яблоки, 3 - воду, 4 - чипсы, 5 - мясо:  '), input('Добавить корзину?  '), input('Гооооо?  '))
